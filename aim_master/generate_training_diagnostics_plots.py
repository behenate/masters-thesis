...
def write_runtime_context_comparison(df: pd.DataFrame) -> None:
    ...
    lines = [
        ...
        r"]",
        rf"\addplot+[fill=plotBlue!72, draw=none, bar shift=0pt] coordinates {{{coords_512}}};",
        rf"\addplot+[fill=plotAccent!72, draw=none, bar shift=0pt] coordinates {{{coords_1024}}};",
