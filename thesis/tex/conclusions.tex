...
kontrolne oceniono dla metody następnego tokenu. Dla klasyfikacji sekwencji,
generowania etykiety i odpowiedzi ustrukturyzowanej sprawdzono po cztery
konfiguracje wybrane na podstawie tego eksperymentu. Dla metod bazowych
sprawdzono ograniczone zbiory parametrów i jeden podział walidacyjny. Naive
Bayes nie podlegał strojeniu, a DistilBERT wytrenowano tylko z jednym zestawem
parametrów.
...
Szersze przeszukanie parametrów Naive Bayes i DistilBERT
