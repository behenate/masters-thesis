...
a następnie przekazuje do klasyfikatora. W przeciwieństwie do klasycznych metod klasyfikacji,
modele językowe uwzględniają zależności między słowami i zdaniami oraz korzystają z wiedzy zdobytej podczas treningu
...
jest ich koszt w porównaniu do klasycznych klasyfikatorów.
...
Dla klasyfikacji przez ocenę następnego tokenu porównano 16
konfiguracji różniących się długością kontekstu, współczynnikiem uczenia i
parametrami adaptera. Oceniono również pośrednie punkty kontrolne. Wybrane
ustawienia wykorzystano później w porównaniu klasyfikacji sekwencji,
...
walidacyjnym. Koszt inferencji zmierzono na wspólnej próbce 1000 wiadomości.
...
\begin{enumerate}
    \item Czy dostrojenie małego modelu językowego za pomocą LoRA pozwala
    poprawnie klasyfikować wiadomości ze zbioru treningowego i ze źródeł
...
najlepszego wariantu z metodami bazowymi. Rozdział końcowy odpowiada na pytania
badawcze, omawia ograniczenia, możliwość wdrożenia klasyfikatora i dalsze
kierunki badań.
