...
w wariancie bajtowego BPE stosowanym w GPT-2. Opracowanie własne.}
...
\begin{landscape}
\begin{figure}[p]
\hspace*{-0.3cm}\begin{minipage}{\linewidth}
\centering
\makebox[\linewidth][c]{\resizebox{0.98\linewidth}{!}{\input{tex/plots/transformer_overview}}}
\caption{Uproszczony przepływ informacji w modelu językowym opartym na
...
\caption{Schemat działania mechanizmu multi-head self-attention. Autor:
Jay Alammar, źródło: \emph{The Illustrated Transformer}
...
Schemat jakościowy, opracowanie własne.}
