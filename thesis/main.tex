% Temporary faster compile: only build the research chapter while editing it.
% To restore the full thesis compile, uncomment the disabled \include lines below.
...
% Temporary research-only compile: uncomment these lines to restore the full thesis.
