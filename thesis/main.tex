...
% Zachowaj tytuł bieżącego rozdziału po lewej stronie nagłówka także w
% jednostronnym układzie dokumentu.
\ihead{\headmark}
\chead{}
\ohead{}
...
% Oświadczenie o samodzielnym wykonaniu pracy jest składane jako osobny dokument.
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\endgroup
\clearpage % Zakończ spis treści przed zmianą numeracji stron.
\KOMAoptions{open=any} % Rozdziały zaczynają się bez wymuszania pustej strony.
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Standardowe \mainmatter wymusza nieparzystą stronę w trybie dwustronnym.
% Poniższe dwie instrukcje włączają część główną i numerację arabską bez
% dodawania pustej strony po spisie treści.
\makeatletter
\@mainmattertrue
\global\c@page\@ne
...
\endgroup
\input{tex/summary} % Anglojęzyczne streszczenie wymagane przez szablon PK
