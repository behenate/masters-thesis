...
DATASET_URL = "https://www.kaggle.com/api/v1/datasets/download/mandygu/lingspam-dataset"
DATASET_DIR = os.path.join(_root, "raw_datasets", "ling")
EXPECTED_PATH = os.path.join(DATASET_DIR, "Ling.csv")
...
def download() -> str | None:
    ...
    downloaded = download_and_unzip_dataset(DATASET_URL, os.path.join(DATASET_DIR, "ling"))
